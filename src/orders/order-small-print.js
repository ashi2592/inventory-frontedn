...
const InvoiceSmallPrint = ({
    ...
    return (<Container>
        ...
        <Card fluid>
            <Card.Content>
                <TwoInchInvoiceTemplaate transcation={transcation} ref={componentRef}></TwoInchInvoiceTemplaate>
            </Card.Content>
        </Card>
    </Container>)
}
...
export default connect(mapStateToProps, mapDispatchToProps)(InvoiceSmallPrint);
