...
const TransactionProducts = ({ addSupplier, handleAddSupplier }) => {
                ...
                <Table>
                    <Table.Body>
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell>
                                <Form.Field
                                    id="form-input-control-supplier-location"
                                    control={Input}
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell>
                                <Form.Field
                                    id="form-input-control-supplier-addresss"
                                    control={Input}
...
export default connect(mapStateToProps, mapDispatchToProps)(TransactionProducts)