            ...
            <Table>
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell textAlign="right"> <Button color='red' onClick={() => { handleDeleteColor(color._id) }}> <Icon name="delete"></Icon> Delete</Button></Table.HeaderCell>
                    </Table.Row>
                </Table.Header>
                <Table.Body>
                    <Table.Row>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>
                            <Checkbox
                                ...
                                label='is Active'
                                onChange={() => handleUpdateFunction(color._id, 'status', !color.status)}
                            />
                        </Table.Cell>
                    </Table.Row>
                </Table.Body>
