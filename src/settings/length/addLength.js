...
import { ADD_COLOR, ADD_LENGTH, ALERT_NOTIFY } from "../../redux/actions";
...
const AddProductLenghtPage = ({ add, alertMessage }) => {
    ...
    return (<Container>
        <Header textAlign="left">Product Length</Header>
                            ...
                            <Table>
                                <Table.Body>
                                    <Table.Row>
                                        ...
                                        <Table.Cell>
                                            <Form.Field
                                                id="form-input-control-length-name"
                                                control={Input}
                                                placeholder='Enter Length Name'
...
const mapDispatchToProps = (dispatch) => ({
    add: (data) => dispatch({ type: ADD_LENGTH, payload: data }),
